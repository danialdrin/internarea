...
import { getApplications, updateApplicationStatus } from "@/data/localData";
// const Applications = [
//   {
//     _id: "1",
//     company: "Tech Corp",
...
const index = () => {
  ...
  const handleacceptandreject = (id: any, action: any) => {
    try {
      const status = action === "approve" ? "approved" : "rejected";
      const updatedData = updateApplicationStatus(id, status);
      setdata(updatedData);
